...
for seed in "${seed_list[@]}"; do
    for selection_p in "${selection_p_list[@]}"; do
        /home/liang142/anaconda3/envs/tsm/bin/torchrun  --nproc_per_node=1 ./tpt_classification_useprompt.py ${data_root} \
        -a ${arch} -b ${bs} --gpu 0 --n_ctx 10 \
        ...
        --logging /media/ssd8T/TPT-video/logging/hmdb51/hmdb51_vit-b-16-f16-seed${seed}-selection_p${selection_p}-test_crop${test_crop}-vifi2shot.log
    done
done
